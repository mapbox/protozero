...
TEST_CASE("repeated_packed_sint32") {
    ...
    SECTION("empty") {
        std::string buffer = get_file_data("test/t/repeated_packed_sint32/data-empty.bin");
    ...
    SECTION("one") {
        std::string buffer = get_file_data("test/t/repeated_packed_sint32/data-one.bin");
