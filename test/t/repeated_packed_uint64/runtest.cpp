...
TEST_CASE("repeated_packed_uint64") {
    ...
    SECTION("empty") {
        std::string buffer = get_file_data("test/t/repeated_packed_uint64/data-empty.bin");
    ...
    SECTION("one") {
        std::string buffer = get_file_data("test/t/repeated_packed_uint64/data-one.bin");
