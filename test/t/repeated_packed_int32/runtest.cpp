...
TEST_CASE("repeated_packed_int32") {
    ...
    SECTION("empty") {
        std::string buffer = get_file_data("test/t/repeated_packed_int32/data-empty.pbf");
    ...
    SECTION("one") {
        std::string buffer = get_file_data("test/t/repeated_packed_int32/data-one.pbf");
    ...
    SECTION("many") {
        std::string buffer = get_file_data("test/t/repeated_packed_int32/data-many.pbf");
...
TEST_CASE("write repeated_packed_int32") {
